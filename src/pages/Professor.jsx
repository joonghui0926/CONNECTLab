...
export default function Professor() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-16 md:py-32">
      <div className="border-b border-fg/20 pb-6 md:pb-8 mb-10 md:mb-16">
        <h1 className="font-serif text-4xl md:text-5xl font-bold text-primary">Professor</h1>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-10 md:gap-16">
        ...
        <div className="lg:col-span-8 space-y-12 md:space-y-20">
          ...
          <section>
            <div className="space-y-4 md:space-y-6 text-secondary font-light leading-relaxed text-justify text-base md:text-lg">
